...
const Intro = () => {
  ...
  return (
    <section
      ref={ref}
      id="home"
      className="scroll-mt-[100rem] mb-28 max-w-[53rem] text-center sm:mb-0">
      ...
      >
        ...
        <span className="font-bold">full-stack React/MERN/Next.js developer</span> with{" "}
        <span className="font-bold">6 months of bootcamp graduate.</span> I enjoy
        building <span className="italic">sites & apps</span>. My focus is{" "}
        <span className="underline">React (MERN/Next.js)</span>.
      </motion.h1>
      ...
      >
        ...
        >
          Contact me here{" "}
          <BsArrowRight className="opacity-70 group-hover:opacity-80 group-hover:translate-x-2 transition" />
        </Link>
